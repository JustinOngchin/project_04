...
while True:
    ...
    if has_not_commented:
        ...
        print('Commented a top level comment')
        ...
        try:
            ...
            print('Commented a reply to a comment')
        except:
            print('Couldn\'t find a valid comment to reply to')
            pass


    # FIXME (task 5): select a new submission for the next iteration;
    # your newly selected submission should be randomly selected from the 5 hottest submissions
    hot_submissions = list(reddit.subreddit("cs40_2022fall").hot(limit=5))
